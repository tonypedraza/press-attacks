...
interface JournalistNamesState {
  journalist: String;
  namesScrollPositionTop: number;
  namesScrollPositionLeft: number;
}

class JournalistNames extends Component<
  JournalistNamesProps,
  JournalistNamesState
> {
  static defaultProps = {
  ...
  render() {
    const { pressAttacksYearSorted, country, paneIsOpen } = this.props;
    ...
    if (paneIsOpen) {
      return (
        <div
          ref={journalistcontainer => {
            this.journalistcontainer = journalistcontainer;
          }}
